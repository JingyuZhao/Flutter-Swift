...
import 'package:flutter_module/config/service_method.dart';
import 'package:flutter_module/config/service_url.dart';
import 'package:flutter_module/custom_widget/home/home_menu_item.dart';
import 'package:flutter_module/custom_widget/home/home_ad_banner.dart';
import 'package:flutter_module/custom_widget/home/home_call_phone.dart';
import 'package:flutter_module/custom_widget/home/home_recommend.dart';
import 'package:flutter_module/custom_widget/home/home_section_header.dart';
import 'package:flutter_module/custom_widget/home/home_section_content.dart';
import 'package:flutter_easyrefresh/easy_refresh.dart';

import 'package:flutter_swiper/flutter_swiper.dart';
import 'package:flutter_module/router/application.dart';
...
class _HomePageState extends State<HomePage>
  ...
  static const gobackMethod = MethodChannel("com.fultter-swift.iosCall");
  static const eventLister = EventChannel("com.fultter-swift.event");
  ...
  void initState() {
    ...
    // 监听事件，同时发送参数12345
    eventLister.receiveBroadcastStream('12345').listen(
        (data) {
          setState(() {
            navTitle = data.toString();
          });
        },
        onError: (error) {},
        onDone: () {
  ...
  var navTitle = "百姓生活+";
  _iosGoBack() async {
    await gobackMethod.invokeMethod("goback", "paramter");
  }
